...
export default function Bayar({ user, dues = [], paymentMethods = [] }) {
    ...
    const [copied, setCopied] = useState(false); // State untuk indikator salin

    // Menentukan prefix URL berdasarkan role pengguna
    const prefix = user.role === 'ketua_rt' ? 'ketuart' : user.role;

    // dues di sini murni berisi tagihan yang DICENTANG saja dari halaman Index
